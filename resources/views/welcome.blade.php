                    ...
                    <div class="group bg-white rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col">
                        ...
                        <div class="p-6 flex flex-col flex-1 justify-between">
                            <div>
                                ...
                                <div class="flex items-center gap-2 text-slate-500 text-sm mb-2 font-medium">
                                ...
                                <!-- ========================================== -->
                                <!-- 🌟 TAMBAHAN: RATING BINTANG EVENT 🌟 -->
                                <!-- ========================================== -->
                                @php
                                    $rataRata = $event->reviews->avg('rating') ?? 0;
                                    $jumlahReview = $event->reviews->count();
                                @endphp
                                ...
                                <div class="flex items-center gap-1 mb-4">
                                    ...
                                    @if($jumlahReview > 0)
                                        <span class="text-sm font-bold text-slate-700">{{ number_format($rataRata, 1) }}</span>
                                        <span class="text-xs font-medium text-slate-500">({{ $jumlahReview }} ulasan)</span>
                                    @else
                                        <span class="text-xs font-medium text-slate-400 italic">Belum ada ulasan</span>
                                    @endif
                                </div>
                                <!-- ========================================== -->
                            </div>
